...
```json
{
  ...
  "problem_contract": {
    ...
    "aliases": [
      "wikipedia:wikipedia-ca3e398f784e597b"
    ],
    "allowed_axioms": [
    ...
    "domain": {
      "description": "Draft source observation in Graph theory, Word-representation of graphs; domain extraction is unresolved.",
      "objects": [
    ...
    "problem_id": "problem:wikipedia-ca3e398f784e597b",
    "quantifiers": [
      {
    ...
    "sources": [
      {
        ...
        "source_record_id": "wikipedia-ca3e398f784e597b",
        "url": "https://en.wikipedia.org/wiki/Word-representable_graph"
      }
    ],
    "statement": {
      "language": "en",
      "text": "Classify graphs with representation number 3, that is, graphs that can be represented using 3 copies of each letter, but cannot be represented using 2 copies of each letter",
      "version": 1
    },
    "title": "Classify graphs with representation number 3, that is, graphs that can be represented using 3 copies of each letter, but cannot be represented using 2 copies of each letter",
    "updated_at": "2026-09-15T21:28:00.195364Z"
  },
  "problem_contract_sha256": "6e0f34f4d77a516c14e04f18d7ca37c9491ea0e7d883614703b2cd5b2beb1a75"
}
```
